...
- Build an evaluation harness: precision, recall, hallucination detection
- Run the harness against the full RAG pipeline
- Summarize results and known failure modes
...
uv sync
python Week-8/scripts/<script_name>.py
```
