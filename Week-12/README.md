# Week 12: Benchmarking & Final Deliverable

## Objectives

- Run performance benchmarks (latency, throughput, cost)
- Consolidate all prior weeks into a final capstone report
...
uv sync
python Week-12/scripts/<script_name>.py
```
