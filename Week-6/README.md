# Week 6: LLM Integration (DeepSeek / OpenRouter)

## Objectives

- Integrate DeepSeek/OpenRouter LLM APIs
- Design and test grounded-answer prompt templates
- Compare prompt variants for faithfulness
...
uv sync
python Week-6/scripts/<script_name>.py
```
