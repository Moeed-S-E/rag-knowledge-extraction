# Week 7: Full RAG Pipeline Wiring

## Objectives

- Wire ingestion -> chunking -> embedding -> retrieval -> generation into one pipeline
- Run end-to-end queries against the full corpus
- Document the pipeline with a worked example
...
uv sync
python Week-7/scripts/<script_name>.py
```
