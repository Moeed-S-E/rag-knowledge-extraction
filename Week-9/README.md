...
- Run topic modeling (LDA/BERTopic) over the corpus
- Label and visualize discovered topics
- Relate topics back to retrieval/generation behavior
...
uv sync
python Week-9/scripts/<script_name>.py
```
